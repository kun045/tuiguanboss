...
<body class="gray-bg">
											                    ...
											                    <div class="ibox-content">
											                        ...
											                        <form class="form-horizontal m-t">
											                            ...
											                            <div class="form-group draggable">
																			...
																			<div class="col-sm-9">
																				<div class="fileQtongyouQfile"></div>
	...
	function getUeditorFormHtml(html,msg,isgx){
		var arryUe = html.split('<div class="ueQtongyouQue"></div>');
		if(arryUe.length == 3){
			var uejscode = "<script id=\"editor\" type=\"text/plain\" style=\"width:96%;height:200px;\"><\/script>";
			if(msg == '1'){
				if(isgx == '2'){
					ueditorHtml = arryUe[1];
					return arryUe[0] + '<div class="ueQtongyouQue"></div>' + uejscode + '<div class="ueQtongyouQue"></div>' + arryUe[2];
				}else{
					return arryUe[0] + '<div class="ueQtongyouQue"></div>' + ueditorHtml + '<div class="ueQtongyouQue"></div>' + arryUe[2];
				}
			}else{
	...
	function getSelectFormHtml(html,msg,isgx){
		var arrySe = html.split('<div class="selQtongyouQsel"></div>');
		if(arrySe.length == 3){
			...
			if(msg == '1'){
				if(isgx == '2'){
					return arrySe[0] + '<div class="selQtongyouQsel"></div>' + selectcode + '<div class="selQtongyouQsel"></div>' + arrySe[2];
				}else{
					selectHtml = arrySe[1];
					return html;
				}
	...
	function getFileFormHtml(html,msg,isgx){
		var arryFile = html.split('<div class="fileQtongyouQfile"></div>');
		if(arryFile.length == 3){
			var filecode = "<input type=\"file\" id=\"tp\" name=\"tp\" />";
			if(msg == '1'){
				if(isgx == '2'){
					fileHtml = arryFile[1];
					return arryFile[0] + '<div class="fileQtongyouQfile"></div>' + filecode + '<div class="fileQtongyouQfile"></div>' + arryFile[2];
				}else{
					return arryFile[0] + '<div class="fileQtongyouQfile"></div>' + fileHtml + '<div class="fileQtongyouQfile"></div>' + arryFile[2];
				};
			}else{
