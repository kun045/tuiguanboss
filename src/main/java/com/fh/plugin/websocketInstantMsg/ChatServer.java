...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("FHadminqqtongyou")){
			this.userjoin(message.replaceFirst("FHadminqqtongyou", ""),conn);
		}if(null != message && message.startsWith("LeaveFHadminqqtongyou")){
			this.userLeave(conn);
